...
# Hugo Site Link Crawler - Public Site
# Purpose: Check for broken links on https://devops-pm-25.educ8.se
# Usage: ./crawl-links-public.sh [--verbose]

BASE_URL="https://devops-pm-25.educ8.se"
VERBOSE=false
TIMEOUT=10
TEMP_FILE=$(mktemp)
